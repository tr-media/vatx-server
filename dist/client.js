...
var Client = (function () {
    function Client(fields, streamDate) {
        this.callsign = '';
        this.cid = '';
        this.realname = '';
        this.clienttype = '';
        ...
        this.distance_from_departure = 0;
        this.status = flightStatus_1.FlightStatus.Unknown;
        this.status_string = '';
        this.estimated_time_of_arrival = moment.utc([2100, 0, 1]);
        this.last_update_from_stream = moment.utc([2000, 0, 1]);
        this.homebase = '';
        this.sort_string = '';
